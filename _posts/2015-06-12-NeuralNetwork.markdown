...
<span class="c">#Pkg.clone(&quot;https://github.com/johnmyleswhite/MNIST.jl.git&quot;);</span>
...
<span class="c"># computes the sigmoid of z.</span>
<span class="c">###########################################</span>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-julia"><pre><span class="c">########################################################################</span>
<span class="c"># computes the gradient of the sigmoid function</span>
<span class="c"># evaluated at z.</span>
<span class="c">########################################################################</span>
