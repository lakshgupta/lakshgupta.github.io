// Utility: return `x` if defined, otherwise `deflt`.
...
CanvasRenderingContext2D.prototype.line = function(x1, y1, x2, y2, color, lineWidth) {
    this.beginPath();
    this.moveTo(x1, y1);
    this.lineTo(x2, y2);
...
CanvasRenderingContext2D.prototype.arrow = function(x1, y1, x2, y2, color, lineWidth) {
...
CanvasRenderingContext2D.prototype.filledRectangle = function(x1, y1, x2, y2, color, fillColor, lineWidth) {
    this.strokeStyle = selfOrDefault(color, "black");
...
CanvasRenderingContext2D.prototype.filledRoundedRectangle = function(x1, y1, x2, y2, r, color, fillColor, lineWidth) {
    this.strokeStyle = selfOrDefault(color, "black");
    this.fillStyle = selfOrDefault(fillColor, "white");
    this.lineWidth = selfOrDefault(lineWidth, 1);
    this.beginPath();
...
CanvasRenderingContext2D.prototype.circle = function(x, y, r, color, lineWidth, fillColor) { 
...
CanvasRenderingContext2D.prototype.quickCircle = function(x, y, r, color, lineWidth) {
    this.beginPath();
...
CanvasRenderingContext2D.prototype.plot = function(data, xScale, yScale, color, lineWidth) {
